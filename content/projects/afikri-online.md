...
The site uses Next.js App Router, TypeScript for type safety, and Tailwind CSS for styling. Static generation ensures instant page loads and excellent SEO performance.
...
- **Markdown** — Content-driven blog and projects
